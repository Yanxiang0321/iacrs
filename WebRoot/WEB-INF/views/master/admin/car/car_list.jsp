...
<body>
    <div class="list-container">
        <h2>
            ...
            <span>
                <a href="${base}/admin/car/forward_add_car">Add</a>
            </span>
        </h2>
        <table class="default">
            <thead>
            ...
            <tbody>
                <c:forEach var="record" items="${paginationModel.pagination.records}">
                    <tr>
                        ...
                        <td>
                            <a href="${base}/admin/car/forward_modify_car?id=${record.car.id}">Modify</a>
                            <a href="${base}/admin/car/delete_car?id=${record.car.id}">Delete</a>
                            <a href="${base}/admin/car/orbit_car?id=${record.car.id}">Tracks</a>
                        </td>
                    </tr>
                </c:forEach>
                <tr>
