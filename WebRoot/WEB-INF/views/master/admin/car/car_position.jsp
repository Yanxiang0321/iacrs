...
<script type="text/javascript">
    $(function()
    {
        ...
        marker.setTitle('${car.car.licencePlate},${position.time}');
        map.addOverlay(marker);
        marker.setAnimation(BMAP_ANIMATION_BOUNCE);
        var label = new BMap.Label("Now Position",{offset:new BMap.Size(20,-10)});
...
<body>
    <div class="list-container">
        <h2>
            ...
            <span>
                <a href="${base}/admin/car/position_car?id=${car.car.id}">Refresh</a>
            </span>
        </h2>
