...
<body>
    <form action="${base}/admin/car/modify_model" method="post">
        <input type="hidden" name="id" value="${car.model.id}"/>
        <table class="detail">
            <thead>
                <tr>
                    <td colspan="2">Modify Car Model</td>
                </tr>
            </thead>
            <tbody>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <select name="coachType" id="coachType">
                            <option value="0">Two Tank</option>
                            <option value="1">Three Tank</option>
